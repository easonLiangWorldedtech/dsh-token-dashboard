...
export const STYLE_TEXT = [
  ...
  '.td-months { position: relative; display: block; padding-left: 36px; height: 16px; margin-bottom: 3px; }',
  '.td-months span { position: absolute; top: 0; font-size: 10.5px; color: var(--td-muted); white-space: nowrap; font-weight: 500; }',
  '.td-row { display: flex; gap: 5px; margin-bottom: 5px; }',
  '.td-weekday { width: 28px; font-size: 11px; color: var(--td-muted); text-align: right; padding-right: 8px; line-height: 16px; }',
  '.td-cell { width: 16px; height: 16px; border-radius: 4px; cursor: pointer; transition: transform .08s; }',
