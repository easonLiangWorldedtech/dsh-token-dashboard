...
export const STYLE_TEXT = [
  ...
  '.td-months { position: relative; display: block; padding-left: 30px; height: 15px; margin-bottom: 2px; }',
  '.td-months span { position: absolute; top: 0; font-size: 10.5px; color: var(--td-muted); white-space: nowrap; font-weight: 500; }',
  '.td-row { display: flex; gap: 4px; margin-bottom: 4px; }',
  '.td-weekday { width: 26px; font-size: 10.5px; color: var(--td-muted); text-align: right; padding-right: 6px; line-height: 13px; }',
  '.td-cell { width: 13px; height: 13px; border-radius: 3px; cursor: pointer; transition: transform .08s; }',
  '.td-cell:hover { transform: scale(1.18); outline: 1.5px solid var(--td-accent); outline-offset: 1px; }',
  '.td-legend { display: flex; align-items: center; gap: 6px; font-size: 11px; color: var(--td-muted); margin-top: 14px; }',
