...
export const STYLE_TEXT = [
  ...
  '.td-months { position: relative; display: block; padding-left: 26px; height: 14px; }',
  '.td-months span { position: absolute; top: 0; font-size: 10px; color: var(--td-muted); white-space: nowrap; }',
  ...
  '.td-tip { position: fixed; z-index: 9999; background: #111827; color: #fff; font-size: 12px; padding: 8px 10px; border-radius: 8px; pointer-events: none; white-space: nowrap; box-shadow: 0 4px 14px rgba(0,0,0,.3); }',
