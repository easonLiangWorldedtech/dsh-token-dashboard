window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function DayTipContent({ day, t }) {
			const top = day.byModel.slice(0, TOP_MODELS);
			const restTokens = day.byModel.slice(TOP_MODELS).reduce((sum, entry) => sum + entry.tokens, 0);
			const restCount = day.byModel.length - top.length;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				day.byModel.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: "sub",
					children: t("empty")
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "divider" }),
